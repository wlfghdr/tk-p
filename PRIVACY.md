...
**Timekiller respektiert deine Privatsphäre.** Diese App:

- ✅ **Erfasst KEINE persönlichen Daten**
- ✅ **Verfolgt NICHT dein Verhalten**
- ✅ **Nutzt KEINE Analyse-Dienste**
- ✅ **Teilt KEINE Daten mit Dritten**
- ✅ **Benötigt KEIN Konto**

### Datenspeicherung

Alle Daten werden **lokal auf deinem Gerät** gespeichert über iOS UserDefaults:
...
**Keine dieser Daten verlässt dein Gerät, es sei denn, du aktivierst Game Center.**

### Game Center (Optional)

Timekiller bietet **optionale** Game Center-Integration auf iOS:

- Game Center ist **standardmäßig deaktiviert**
...
- **Mit Game Center geteilte Daten:**
  ...
  - Dein Achievement-Fortschritt (Prozentsätze)
  - Keine persönlichen Informationen außer dem, was Game Center bereits hat
- Game Center ist **nicht verfügbar** auf watchOS
- Du kannst Game Center jederzeit in den Einstellungen deaktivieren
- Alle Daten werden über Apples Game Center-Server verarbeitet
- Apples Game Center-Datenschutzrichtlinie gilt für diese Funktion

### In-App-Käufe

Falls du Premium-Features kaufst:
- Transaktionen werden vom Apple App Store abgewickelt
- Apples Datenschutzrichtlinie gilt für die Zahlungsabwicklung
...
Diese App ist sicher für Kinder:
- Keine Datenerfassung standardmäßig
- Game Center ist optional und standardmäßig deaktiviert
- Keine Werbung
- Keine externen Links (außer GitHub in Einstellungen)
- Keine nutzergenerierten Inhalte
- Keine sozialen Funktionen außer optionalen Game Center-Bestenlisten

### Deine Rechte

Du kannst:
- Alle App-Daten durch Deinstallation löschen
...
This app:
- ❌ Does NOT connect to any servers (except when Game Center is enabled)
- ❌ Does NOT make network requests (except for optional Game Center)
- ❌ Does NOT load remote content
- ✅ Only contacts Apple servers for:
...
**Privacy is a fundamental right. Timekiller respects that.** 🔒
